...
<body class="body_a">
        ...
        <div class="contenido-main">
            ...
            <div class="bloque-botones">
                ...
                <div class="boton-añadir">
                    <a class="quita-borde" href="nuevo-usuario.php"><button class="boton-añadir-general">Añadir</button></a>
                </div>
                <div class="bloque-tabla">
                    <table class="rounded-table">
                        ...
                        <tbody>
                            <?php foreach($resultadoConsulta as $usuarios){?>
                                <tr class="categoria-cell" data-id="<?php echo $usuarios['id']; ?>">
    ...
    <script src="js/clickUsuarios.js"></script>
</body>
