...
if (isset($_POST['insertar'])) { // Verifica si el formulario se ha enviado
    ...
    if (empty($errores)) {
        $consulta2 = "INSERT INTO usuarios (username, pasword, nombre, apellido1, apellido2, email, id_rol, id_departamento) values ('$username','$pasword','$nombre','$apellido1','$apellido2','$email','$rol','$departamento')";
        ...
        <div class="contenido-main">
            ...
            <div class="bloque-botones">
                ...
                <div class="titulo-paginas">
                    <h2 class="titulo-paginas-h2">NUEVO USUARIO</h2>
                </div>
                <form class="formulario" method="post">
                    <div class="datos-formu">
                        ...
                        <?php if (intval($state) === 2): ?>
                            <div class="alerta succes">
                                <?php echo "Usuario insertado correctamente"; ?>
                            </div>
                        <?php endif; ?>
                    </div>
                    <div class="datos-formu">
                    ...
                    <div class="datos-formu">
                        ...
                        <select class="formulario-input formulario-input-select" name="rol">
                            <option value="">--Seleccionar--</option>
