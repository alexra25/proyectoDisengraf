        ...
        <div class="contenido-main">
            ...
            <div class="bloque-botones">
                ...
                <div class="titulo-paginas">
                    <h2 class="titulo-paginas-h2">PRODUCTOS</h2>
                </div>
                <div class="botones-departamentos">
                    <buttom class="boton-departamento">TODOS</buttom>
                    <buttom class="boton-departamento">OFICINA</buttom>
                    <buttom class="boton-departamento">DIBUJO</buttom>
                    <buttom class="boton-departamento">MONTAJE</buttom>
                    <buttom class="boton-departamento">CLICHÉS</buttom>
                </div>
