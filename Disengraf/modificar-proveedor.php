...
$con = new Conexion();
$resultadoConsulta = $con->queryAll($consulta_proveedores);
...
$proveedores = $resultadoConsulta2[0];
$state = 0;

if (isset($_POST['borrar'])) {
    $id_borrar = $id;
    $consulta2 = "DELETE FROM proveedores WHERE id = $id_borrar";
    $con = new Conexion();
...
if (isset($_POST['modificar'])) {
    ...
    if (empty($errores)) {
        $consulta3 = "UPDATE proveedores SET id='$codigo',proveedor='$proveedor',referencia='$referencia',direccion='$direccion',poblacion='$poblacion',pais='$pais',provincia='$provincia',codPostal='$codPostal',telefono='$telefono',correo='$correo',nacional='$nacional' WHERE id = $id_modificar";
        $con = new Conexion();
        ...
        <div class="contenido-main">
            ...
            <div class="bloque-botones">
                ...
                <div class="titulo-paginas">
                    <h2 class="titulo-paginas-h2">MODIFICAR PROVEEDOR</h2>
                </div>
                <form class="formulario" method="post">
                    ...
                    <div class="datos-formu">
                        ...
                        <a class="contenedor-boton-volver" href="proveedores.php">
